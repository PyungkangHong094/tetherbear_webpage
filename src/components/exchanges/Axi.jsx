      ...
      <div className="exchange-guide-container">
        ...
        <div className="exchange-header">
          <div className="exchange-logo-wrapper">
            <img
              src="/images/partners/axi.png"
              alt="Axi Logo"
              className="exchange-logo-large"
            />
          </div>
          <h1 className="exchange-name">Axi (악시)</h1>
          <p className="exchange-subtitle">
            빠른 실행 속도의 FOREX 거래소 가입 가이드
          </p>
          ...
          >
            <div className="guide-steps">
              <div
                ...
                onClick={() => window.open("https://www.axi.com/", "_blank")}
          ...
          >
            <div className="guide-steps">
              ...
              <div className="guide-step">
                <div className="step-number">3</div>
                <div className="step-content">
                  <div className="step-title">셀카 인증</div>
                  <div className="step-description">
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  <div className="step-title">심사 대기 (즉시-24시간)</div>
                  <div className="step-description">
                    Axi는 빠른 승인 절차로 유명합니다. 대부분 몇 시간 내에
                    승인됩니다.
                  </div>
                </div>
              </div>
            ...
            <div className="info-box">
              ...
              <div className="info-box-content">
                <ul>
                  <li>선명한 고화질 이미지로 촬영</li>
                  <li>신분증의 모든 정보가 읽을 수 있어야 함</li>
                  <li>반사광 제거 필수</li>
            ...
            <div className="guide-steps">
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    Axi의 표준 계좌 최소 입금액은 $0입니다. 프로 계좌는
                    $1,000부터 시작합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                <div className="step-number">3</div>
                <div className="step-content">
                  <div className="step-title">MT4 플랫폼 설치</div>
                  <div className="step-description">
                    PC 또는 모바일에 MetaTrader 4 플랫폼을 설치하고 계정 정보로
                    로그인합니다.
                  </div>
                </div>
              </div>
        ...
        <div className="cta-section">
          <h2 className="cta-title">지금 바로 Axi에서 함께해요!</h2>
