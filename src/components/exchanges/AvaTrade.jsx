      ...
      <div className="exchange-guide-container">
          ...
          >
            <div className="guide-steps">
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.avatrade.co.kr/trading-account/?p=MetaTrader5&tag=215986",
                    "_blank"
                  )
                }
          ...
          >
            <div className="guide-steps">
              ...
              <div className="guide-step">
                <div className="step-number">3</div>
                <div className="step-content">
                  <div className="step-title">주소 증빙서류 제출</div>
                  <div className="step-description">
                    최근 3개월 이내 발급된 공과금 고지서 또는 은행 명세서를
                    제출합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  <div className="step-title">심사 대기 (1-3영업일)</div>
                  <div className="step-description">
                    제출 후 보통 1-3영업일 내에 승인 결과가 이메일로 전송됩니다.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="info-box">
              ...
              <div className="info-box-content">
                <ul>
                  <li>모든 서류는 선명하게 촬영해야 함</li>
                  <li>주소 증빙서류는 현재 거주지와 일치해야 함</li>
                  <li>신분증 유효기간 확인 필수</li>
            ...
            <div className="guide-steps">
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    AvaTrade의 최소 입금액은 $100입니다. 처음에는 소액으로
        ...
        <div className="cta-section">
          ...
          <div className="cta-buttons">
            <a
              href="https://www.avatrade.co.kr/trading-account/?p=MetaTrader5&tag=215986"
              target="_blank"
              rel="noopener noreferrer"
