    ...
    <div className="exchange-guide-page">
      ...
      <div className="exchange-guide-container">
        ...
        <div className="exchange-header">
          ...
          <h1 className="exchange-name">OKX (오케이엑스)</h1>
          <p className="exchange-subtitle">
            글로벌 Top5 암호화폐 거래소 가입 가이드
          </p>
          <div className="exchange-benefits">
            <span className="benefit-badge">💰 PAYBACK 40%</span>
          ...
          >
            <div className="guide-steps">
              ...
              >
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    반드시 테더베어 제휴 링크를 통해 가입해야 40% 페이백 + 20%
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    이메일 주소 또는 휴대폰 번호 중 하나를 선택하여 가입할 수
                    있습니다. 안전한 비밀번호를 설정하세요.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    이메일 또는 SMS로 발송된 인증 코드를 입력하여 계정을
                    활성화합니다.
                  </div>
                </div>
              </div>
            ...
            <div className="info-box">
              ...
              <div className="info-box-content">
                <ul>
                  <li>
                    테더베어 전용 링크로만 가입해야 40% 페이백 + 20% 할인 적용
                  </li>
                  <li>레퍼럴 코드: TETHERBEAR 확인 필수</li>
                  <li>인증 코드 입력 후 즉시 거래 가능</li>
                  <li>2단계 인증(2FA) 설정 강력 권장</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="guide-steps">
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    OKX는 3단계 KYC 시스템을 운영합니다. 레벨 1(기본), 레벨
                    2(중급), 레벨 3(고급) 중 선택하세요. 높은 레벨일수록 출금
                    한도가 증가합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    실명, 생년월일, 국적, 거주지 주소 등을 정확하게 입력합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    여권, 주민등록증, 운전면허증 중 하나를 선택하여 촬영 후
                    업로드합니다. 양면 모두 선명해야 합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    카메라를 이용한 실시간 얼굴 인식 절차를 진행합니다. 화면의
                    지시에 따라 고개를 움직이세요.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  <div className="step-title">심사 대기 (10분-24시간)</div>
                  <div className="step-description">
                    대부분 10-30분 내에 자동 승인됩니다. 추가 검토가 필요한 경우
                    최대 24시간 소요될 수 있습니다.
                  </div>
                </div>
              </div>
            ...
            <div className="info-box">
              ...
              <div className="info-box-content">
                <ul>
                  ...
                  <li>얼굴 인식 시 마스크나 안경 착용 금지</li>
                  <li>레벨 2 이상 인증 시 출금 한도 대폭 증가</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="guide-steps">
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    암호화폐 입금(BTC, ETH, USDT 등), 신용카드, P2P 거래 등
                    다양한 방법을 지원합니다. 한국에서는 P2P 거래가 가장
                    편리합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    암호화폐별로 최소 입금액이 다릅니다. USDT 기준 최소 $10부터
                    입금 가능합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                <div className="step-number">3</div>
                <div className="step-content">
                  <div className="step-title">OKX 앱 설치 (선택)</div>
                  <div className="step-description">
                    모바일 거래를 위해 OKX 공식 앱을 설치할 수 있습니다. 웹
                    브라우저에서도 모든 기능 이용 가능합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    현물 거래, 선물 거래, 옵션 등 다양한 상품을 거래할 수
                    있습니다. 테더베어의 시그널과 지표를 활용하세요.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="guide-section">
          ...
          >
            <div className="guide-steps">
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    계정 설정에서 레퍼럴 코드가 "TETHERBEAR"로 등록되어 있는지
                    확인합니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-description">
                    테더베어 링크로 가입하면 거래 수수료가 자동으로 20% 할인
                    적용됩니다.
                  </div>
                </div>
              </div>
              ...
              <div className="guide-step">
                <div className="step-number">3</div>
                <div className="step-content">
                  <div className="step-title">페이백 40% 신청</div>
                  <div className="step-description">
                    매월 테더베어 팀에 페이백을 신청하면 거래 수수료의 40%를
                    현금으로 돌려받습니다. (할인 20% + 페이백 40% = 총 60% 혜택)
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="info-box">
              ...
              <div className="info-box-content">
                <ul>
                  <li>거래 수수료의 40% 매월 페이백 (업계 최고 수준)</li>
        ...
        <div className="cta-section">
          <h2 className="cta-title">지금 바로 OKX에서 함께해요!</h2>
          <p className="cta-description">
            테더베어 전용 링크로 가입하고 40% 페이백 + 20% 할인 혜택을 받으세요
            <br />
            레퍼럴 코드 : TETHERBEAR
            <br />
