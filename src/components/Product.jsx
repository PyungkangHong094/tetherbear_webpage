    ...
    <div>
      ...
      <div className="section-tablet-scroll-animation">
          ...
          <div className="p-xl-start p-xl-end">
            <div className="text-center">
              <div className="wow-animation">
                ...
                <a href="/pricing" className="button-2 is-yellow margin-top-30 w-button">고급 차트 받기</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-w2 gutter-outside">
          <div className="tablet-mockup-animation" data-w-id="cc2bda7f-df30-f320-d65c-506b24b40f03">
            <div className="_3d-tablet-wrap" data-w-id="cc2bda7f-df30-f320-d65c-506b24b40f04">
                ...
                <div className="ipad-mockup">
                  <div className="ipad-screen overflow-hidden">
                    <img 
                      ...
                      srcSet="/images/slider-3-p-500.jpeg 500w, /images/slider-3-p-800.jpeg 800w, /images/slider-3.jpg 1791w" 
                      alt="" 
          ...
          <div id="about" className="main-section">
            <div className="main-container">
              <div className="w-layout-grid _1-2-grid reverse">
                <img 
                  src="/images/chartgetalgoIndicator.png" 
                  loading="lazy" 
                  height="Auto" 
                  alt="" 
                  srcSet="/images/차트겟-보조지표-p-500.png 500w, /images/차트겟-보조지표-p-800.png 800w, /images/차트겟-보조지표-p-1080.png 1080w, /images/chartgetalgoIndicator.png 1500w" 
                  sizes="(max-width: 1439px) 90vw, 1100px" 
                  className="hero-image-2"
                />
                <div className="content-wrap">
                  <h2 className="h2">We're on a huge mission</h2>
                  <div className="spacer-m"></div>
                  <p className="paragraph-5">우리는 전 세계 트레이더들이 더 나은 결정을 내릴 수 있도록 돕는 혁신적인 거래 도구를 개발합니다. 최첨단 AI 기술과 데이터 분석을 통해 시장의 복잡성을 단순화하고, 누구나 쉽게 이해할 수 있는 직관적인 인터페이스를 제공합니다.</p>
        ...
        <div className="page-wrapper-2">
          ...
          <div id="about" className="main-section">
            <div className="main-container">
              <div className="w-layout-grid _1-2-grid reverse">
                <div className="content-wrap">
                  <h2 className="h2">고급 기술적 분석 도구</h2>
                  <div className="spacer-m"></div>
                ...
                <img 
                  src="/images/CHartget-algo-1.png" 
                  loading="lazy" 
                  alt="" 
                  className="hero-image-2"
                  srcSet="/images/CHartget-algo-1-p-500.png 500w, /images/CHartget-algo-1-p-800.png 800w, /images/CHartget-algo-1-p-1080.png 1080w, /images/CHartget-algo-1.png 1500w"
                />
              </div>
            </div>
          </div>
        ...
        <div className="page-wrapper-2">
          ...
          <div id="about" className="main-section">
            <div className="main-container">
              <div className="w-layout-grid _1-2-grid reverse">
                <img 
                  src="/images/chart.json" 
                  loading="lazy" 
                  alt="" 
                  className="hero-image-2"
                />
                <div className="content-wrap">
                  <h2 className="h2">실시간 데이터와 알림</h2>
                  <div className="spacer-m"></div>
                  <p className="paragraph-5">24시간 실시간으로 업데이트되는 데이터를 바탕으로 한 정확한 시장 분석과 즉시 알림 서비스를 제공합니다. 언제 어디서나 중요한 거래 기회를 놓치지 않도록 도와드립니다.</p>
                  <div className="spacer-l"></div>
                </div>
              </div>
            </div>
      ...
      <div className="container-2">
        <div className="hero-wrapper">
          <div 
            className="hero-background-image projects"
            style={{
        ...
        <div className="footer-container">
          ...
          <div className="footer-social">
            <div className="social-icons">
              <a href="https://www.facebook.com/tetherbear" target="_blank" className="social-link">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              
              <a href="https://twitter.com/tetherbear" target="_blank" className="social-link">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              
              <a href="https://www.instagram.com/tetherbear/" target="_blank" className="social-link">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://discord.gg/tetherbear" target="_blank" className="social-link">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.linkedin.com/company/tetherbear/" target="_blank" className="social-link">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
