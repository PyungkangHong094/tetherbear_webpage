    ...
    <div>
      ...
      <div className="section-tablet-scroll-animation">
        ...
        <div className="container-w2 gutter-outside">
          <div
            data-w-id="cc2bda7f-df30-f320-d65c-506b24b40f03"
            className="tablet-mockup-animation"
          >
            <div
              data-w-id="cc2bda7f-df30-f320-d65c-506b24b40f04"
            ...
            <div className="main-container">
              <div className="w-layout-grid _1-2-grid reverse">
                <img
                  ...
                  loading="lazy"
                  id="w-node-_46d3e7ab-541e-9517-e836-da6644dd3473-49f2a8a2"
                  height="Auto"
                  alt=""
                  srcset="images/차트겟-보조지표-p-500.png 500w, images/차트겟-보조지표-p-800.png 800w, images/차트겟-보조지표-p-1080.png 1080w, images/chartgetalgoIndicator.png 1500w"
            ...
            <div className="main-container">
              <div className="w-layout-grid _1-2-grid reverse">
                ...
                >
                  ...
                  <div className="spacer-m"></div>
                  <p className="paragraph-5">
                    고급 반전 신호, 완전 자동화된 가격 조치 툴킷 및 20개 이상의
                    프리미엄 기능에 액세스하세요. 지금까지 만들어진 가장 발전된
                    지표는 모두 커뮤니티 피드백을 바탕으로 만들어졌습니다.
                  </p>
                  <div className="spacer-l"></div>
                </div>
                <img
                  src="https://assets-global.website-files.com/62eb909a3fa9a704a2e98187/62eb909a3fa9a767dce981e4_pexels-pixabay-461064.jpg"
                  loading="lazy"
          ...
          <div className="content-wrapper">
            <div className="content-width">
              ...
              <h3 className="sub-heading light-text">
                ...
                <strong>any market</strong>. Works on any device and it&#x27;s
                all real-time data.
              </h3>
            </div>
          </div>
        ...
        <div className="footer-container">
          ...
          <div className="footer-social">
            <div className="social-icons">
              <a
                href="https://www.facebook.com/tetherbear"
                target="_blank"
              ...
              <a
                href="https://twitter.com/tetherbear"
                target="_blank"
                className="social-link"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/tetherbear/"
                target="_blank"
                className="social-link"
              >
                <svg
              ...
              <a
                href="https://discord.gg/tetherbear"
                target="_blank"
                className="social-link"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/company/tetherbear/"
                target="_blank"
                className="social-link"
              >
                <svg
